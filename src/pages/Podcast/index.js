...
import {Container, EpisodeList, PodcastDetails, Background, Cover, PodcastTitle, PlayButton, PlayButtonText, Episode, Title, Author, BackButton} from './styles';
...
class Podcast extends React.Component{
  ...
  render(){
    ...
    return(
      <Container>
        <EpisodeList ListHeaderComponent={()=>(
          <PodcastDetails>
        ...
        )} data={podcast.tracks} keyExtractor={ episode => String(episode.id) } renderItem={({item:episode})=>(
